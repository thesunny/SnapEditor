...
require ["jquery.custom", "markupeditor", "snapeditor.pre", "core/browser", "core/editor.in_place", "core/editor.form", "core/editor.unsupported"], (($, Pre, Browser, InPlaceEditor, FormEditor, UnsupportedEditor) ->
